...
const SignUp = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!isPasswordValid) {
      alert(
        "Please enter a valid password (at least 8 characters with letters and numbers)."
      );
      return;
    }
  ...
  return (
    <>
      <div className="relative w-full h-screen lg:h-auto md:w-screen  md:h-screen bg-cover bg-gray-800 flex justify-center items-center overflow-hidden lg:overflow-visible">
        <img
          src={signupBgImage}
        ...
        <div className="flex justify-center items-center w-full opacity-95 lg:w-1/2 lg:my-4">
          <form className="bg-white p-4 m-4 md:p-8 rounded-md w-full h-full md:py-8 md:w-3/4 md:h-auto">
